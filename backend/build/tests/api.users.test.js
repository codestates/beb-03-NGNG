...
describe('main Page', function () {
    ...
    test("login success", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    cookies = _a.sent();
                    console.log(cookies);
                    return [4 /*yield*/, supertest_1.default.get('/api/user/logout').set('Cookie', cookies)];
                case 2:
                    response = _a.sent();
...
//# sourceMappingURL=api.users.test.js.map