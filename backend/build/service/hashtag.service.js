...
exports.getTopHashTag_service = void 0;
var typeorm_1 = require("typeorm");
var HashTag_1 = require("../typeorm/entity/HashTag");
var getTopHashTag_service = function (_a) {
            ...
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, typeorm_1.getRepository)(HashTag_1.HashTag)
                            ...
                            .select("hash_tag.tag AS tag")
                            .addSelect("COUNT(*) AS tagCount")
                            .groupBy("hash_tag.tag")
                            .limit(limit)
                            .getRawMany()];
                case 1:
                    hashTag = _c.sent();
...
exports.getTopHashTag_service = getTopHashTag_service;
